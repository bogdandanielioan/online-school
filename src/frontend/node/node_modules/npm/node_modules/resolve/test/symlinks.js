...
test('packageFilter', function (t) {
    ...
    function testPackageFilter(preserveSymlinks) {
        return function (st) {
            ...
            var destMain = 'symlinks/dest/node_modules/mod-a/PrivateRouteCourseDetails.js';
            var destPkg = 'symlinks/dest/node_modules/mod-a/package.json';
            var sourceMain = 'symlinks/source/node_modules/mod-a/PrivateRouteCourseDetails.js';
